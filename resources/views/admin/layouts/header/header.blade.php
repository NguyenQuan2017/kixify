 <header id="header" class="ui-header">
                ...
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand">
                        <span class="logo"><img src="{{asset('admin/assets/images/logo-dark.png')}}" alt=""/></span>
                        <span class="logo-compact"><img src="{{asset('admin/assets/images/logo-icon-dark.png')}}" alt=""/></span>
                    </a>
                    <!--logo end-->
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown dropdown-usermenu">
                            <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                <div class="user-avatar"><img src="{{asset('admin/assets/images/a0.jpg')}}" alt="..."></div>
